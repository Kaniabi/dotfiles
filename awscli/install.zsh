...
if [[ ! -f /usr/local/bin/session-manager-plugin ]]; then
  ...
  curl --silent curl "https://s3.amazonaws.com/session-manager-downloads/plugin/latest/ubuntu_64bit/session-manager-plugin.deb" -o "/tmp/session-manager-plugin.deb"
